...
window; the selected model and provider remain authoritative limits. If the model spends
...
## Adaptive staffing (1.6.7 / production profile revision 4)
...
### Documentation before delivery planning (1.6.7)
...
project direction and submitted for exact-revision review. The scoped documentation handoff
...
### Independent production commitments (1.6.7)
